...
public class AuthService {
    ...
    public LoginResponse login(LoginRequest request) {
        ...
        String accessToken = jwtUtil.generateToken(user.getEmail(), user.getRole().name(), user.getId(), user.getSchoolId());
    ...
    public LoginResponse refreshToken(String refreshToken) {
        try {
            ...
            String newAccessToken = jwtUtil.generateToken(user.getEmail(), user.getRole().name(), user.getId(), user.getSchoolId());
