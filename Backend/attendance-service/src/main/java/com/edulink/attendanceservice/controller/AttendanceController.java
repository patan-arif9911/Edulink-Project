...
public class AttendanceController {
    ...
    /* ── Legacy paths (without /attendance prefix) for backward compatibility ── */
    @PostMapping("/legacy/teacher/mark-attendance")
    @PreAuthorize("hasRole('TEACHER')")
    public ResponseEntity<ApiResponse<Attendance>> markAttendanceLegacy(@RequestBody Attendance attendance) {
