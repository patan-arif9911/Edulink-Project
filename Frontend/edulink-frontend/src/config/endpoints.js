const BASE = process.env.REACT_APP_GATEWAY_URL || "http://localhost:8060";
...
const Endpoints = {
  ...
  student: {
    ...
    materials:           (code) =>  `${BASE}/student/materials/${code}`,
    ...
    assignments:         (code) =>  `${BASE}/student/assignments/${code}`,
