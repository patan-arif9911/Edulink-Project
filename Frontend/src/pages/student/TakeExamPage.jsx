            ...
            <>
              <div style={{ display: "flex", gap: "0.6rem", marginBottom: "0.6rem", flexWrap: "wrap" }}>
                <button
                  ...
                  style={{ padding: "0.3rem 0.75rem", fontSize: "0.82rem", background: "#1a73e8" }}
                  onClick={() => window.open(pdfUrl, "_blank", "noopener,noreferrer")}
                  title="Open the question paper in a new tab"
                >
                  Open in new tab
                </button>
                <a
                  ...
                  className="submit-btn"
                  style={{ padding: "0.3rem 0.75rem", fontSize: "0.82rem", textDecoration: "none", display: "inline-flex", alignItems: "center" }}
                >
                  Download Questions
                </a>
              </div>
